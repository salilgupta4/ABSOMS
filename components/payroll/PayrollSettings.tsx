...
const ToggleSwitch: React.FC<{ label: string; checked: boolean; onChange: (checked: boolean) => void; }> = ({ label, checked, onChange }) => (
    <div className="flex items-center justify-between">
        ...
        <button
            type="button"
            className={`${checked ? 'bg-primary' : 'bg-slate-200'} relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out`}
                ...
                <Card title="Salary Components (%)">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="basic_pay_percentage" value={settings.basic_pay_percentage || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded"/>
                        </div>
                         <div>
                            <label>HRA %</label>
                            <input type="number" name="hra_percentage" value={settings.hra_percentage || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded"/>
                        </div>
                         <div>
                            <label>Special Allowance %</label>
                            <input type="number" name="special_allowance_percentage" value={settings.special_allowance_percentage || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded"/>
                        </div>
                    </div>
                </Card>
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4 items-center">
                            ...
                            <div>
                                ...
                                <input type="number" name="pf_percentage" value={settings.pf_percentage || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded" disabled={!settings.pf_enabled}/>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4 items-center">
                            <ToggleSwitch label="ESI Enabled" checked={!!settings.esi_enabled} onChange={val => setSettings(p => ({...p, esi_enabled: val}))}/>
                             <div>
                                ...
                                <input type="number" name="esi_percentage" value={settings.esi_percentage || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded" disabled={!settings.esi_enabled}/>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4 items-center">
                           ...
                           <div>
                                ...
                                <input type="number" name="pt_amount" value={settings.pt_amount || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded" disabled={!settings.pt_enabled}/>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4 items-center">
                           ...
                           <div>
                                ...
                                <input type="number" name="tds_percentage" value={settings.tds_percentage || ''} onChange={handlePercentageChange} className="w-full p-2 border rounded" disabled={!settings.tds_enabled}/>
                            </div>
                        </div>
                    </div>
                </Card>
